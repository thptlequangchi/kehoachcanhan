...
(() => {
    ...
    function staticCommands() {
        return [
            ...
            {id:'nav:gradebook',icon:'📒',title:'Sổ điểm cá nhân',subtitle:'Điểm TX, giữa kỳ, cuối kỳ và ĐTB theo lớp/môn/học kỳ',tag:'Điều hướng',keywords:'so diem ca nhan diem thuong xuyen tx giua ky cuoi ky',action:()=>activateTab('gradebook')},
            {id:'nav:homeroom',icon:'🏫',title:'Sổ chủ nhiệm',subtitle:'Hồ sơ học sinh, chuyên cần, nề nếp, phụ huynh và nhật ký lớp',tag:'Điều hướng',keywords:'so chu nhiem hoc sinh chuyen can ne nep phu huynh lop',action:()=>activateTab('homeroom')},
            ...
            {id:'section:year-dashboard',icon:'📊',title:'Dashboard năm học',subtitle:'Xem toàn cảnh 39 tuần lịch năm học: 2 tuần phụ + 37 tuần chính',tag:'Dashboard',keywords:'dashboard nam hoc 39 tuan 37 tuan 2 tuan phu tong quan',action:()=>scrollToId('yearDashboard')},
