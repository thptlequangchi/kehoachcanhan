...
(() => {
    ...
    function staticCommands() {
        return [
            ...
            {id:'nav:links',icon:'🔗',title:'Trung tâm Liên kết',subtitle:'TEMIS, vnEdu, TKB trường, VN ERP và liên kết cá nhân',tag:'Điều hướng',keywords:'lien ket website temis vnedu vnerp',action:()=>activateTab('links')},
