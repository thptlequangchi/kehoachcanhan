...
(() => {
    ...
    function coreQuickTests() {
        const tests = [];
        tests.push(runSync('app-version','Phiên bản ứng dụng','Khởi động',() => APP_VERSION === '53.3.2' ? `APP_VERSION ${APP_VERSION}.` : {status:'fail',message:`APP_VERSION hiện là ${APP_VERSION}.`}));
