/* ============================================================================
   SỔ TAY GIÁO VIÊN v43 — TRUNG TÂM KIỂM TRA SỨC KHỎE & CHẨN ĐOÁN
...
(() => {
    ...
    function quickHealthResults() {
        ...
        if (!lastBackup) add(results, 'backup', 'Sao lưu gần nhất', 'warn', 'Chưa ghi nhận lần sao lưu file nào ở v43');
        else {
